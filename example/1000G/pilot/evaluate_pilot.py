...
Platinum pedigree: HiSeq 2000 2x100, ~50x, the CEU trio).
    ...
    python example/1000G/pilot/evaluate_pilot.py            # writes pilot_report.md + tables here
...
def main():
    ...
    if len(common) >= 6:
        ...
        if write_anchors:
            out = ROOT / "resources" / "GRCh38" / "anchors.json"
            out.write_text(json.dumps({"rDNA45S": {
                ...
                "derived_from": f"{len(common)} sample pairs: NYGC NovaSeq 2x150 vs HGSVC HiSeq 2500 2x126 / Platinum HiSeq 2000 2x100 "
                                "(example/1000G/pilot/evaluate_pilot.py --write-anchors)"}}, indent=1))
